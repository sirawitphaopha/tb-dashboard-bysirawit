...
- **คลังความรู้วัณโรค (ระบบ PDF) — v0.8** — เก็บไฟล์ PDF (ไกด์ไลน์/Trial/อื่นๆ) บน R2 อ่านในเว็บได้เลยด้วยตัวอ่าน PDF เต็มรูปแบบ (เลื่อนหน้า/ซูม/หมุน/หน้าย่อ/ค้นหา+ไฮไลต์ไทย/เลือก-คัดลอก/ดาวน์โหลด/พิมพ์) · ทุกคนอ่านได้ · แอดมินอัป/ลบ (optimistic 2 ขั้น) · ทัมเนลหน้าแรกอัตโนมัติ (2K) + ปรับขนาด 3 ระดับ + realtime ข้ามเครื่อง · เข้าจากหน้าคลังความรู้เดิม
