...
- **ขอลบรูป (เฟส 2) + ลบอัตโนมัติ (v0.7.20)** — ลบรูปตรง = แอดมินเท่านั้น · คนอื่นกด "ขอลบรูป" → รูปขึ้นฝ้าขาว "รออนุมัติลบ" + แจ้งเมล/กระดิ่งแอดมิน → แอดมินอนุมัติ (เข้าถังขยะ) หรือปฏิเสธ (กลับปกติ) · รูปในถังเกิน 60 วันถูกลบอัตโนมัติ (row + ไฟล์ R2)
