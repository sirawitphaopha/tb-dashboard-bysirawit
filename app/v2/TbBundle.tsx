...
/**
 * TbBundle — v0.7.17.0 Phase 3 Step 3
 *
 * แยกออกจาก TbAppMount เพราะ dynamic({ssr:false}) ต้อง import จากไฟล์อื่น
 * ลำดับ import (ES module — depth-first, statement order):
